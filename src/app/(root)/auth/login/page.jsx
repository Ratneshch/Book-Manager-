  ...
  return (
    <Card className="py-10 w-full max-w-[400px] mx-auto flex justify-center rounded-xl shadow-[0px_48px_100px_0px_rgba(17,12,46,0.15)] overflow-hidden">
      <CardHeader className="text-center">
        <CardTitle className="sm:text-3xl text-2xl font-bold">Login</CardTitle>
      ...
      <CardContent>
        <form id="form-rhf-demo" onSubmit={form.handleSubmit(loginSubmit)}>
          {/* user email */}
          <Controller
            name="email"
          ...
          <div className="flex justify-center">
            <ButtonLoader
              ...
              type="submit"
              loading={loading}
              className="cursor-pointer border border-yellow-600 text-black text-md py-5 w-full mt-3 rounded-full"
            />
          </div>
